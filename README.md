...
|---|---|
| **Languages** | JavaScript · TypeScript · Python · PHP · Dart · SQL |
| **Frontend** | React · Next.js · Vue · Nuxt · Redux · Tailwind CSS · SASS |
| **Backend** | Laravel · Node.js · Express · NestJS · Django · FastAPI |
| **Mobile** | React Native · Expo · Flutter |
| **AI / LLM** | LangChain · LangGraph · RAG · Vector DBs · OpenAI · Anthropic |
